...
#======================================== Fitur User/Pengguna===============================================
        ...
        def order_makanan(username):
            while True:
                ...
                lihat_makanan()
                saldo = user["saldo"]
                data_makanan = load_data_makanan()  # Memuat data makanan dengan benar
                ...
                if sort_option == 'ya':
                    ...
                    data_makanan = merge_sort(data_makanan, "harga", reverse)
                ...
                if search_option == 'ya':
                    ...
                    data_makanan = search_item(data_makanan, keyword)
                    ...
                    if data_makanan:
                        ...
                        print("Tidak ada makanan yang ditemukan dengan kata kunci tersebut.")
                        continue  # Kembali ke awal loop untuk mencoba lagi

                # Memilih item untuk dipesan
                while True:
                    try:
                        item_no = int(input("Masukkan nomor makanan yang ingin dibeli: "))
            ...
            while True:
                ...
                while True:
                    try:
                        ...
                        # Menanyakan apakah pengguna ingin memesan barang lain
                        continue_order = input("Apakah Anda ingin memesan barang lain? (ya/tidak): ").strip().lower()
                        if continue_order != 'ya':
                            print("Terima kasih telah berbelanja!")
                            return  # Keluar dari fungsi jika pengguna tidak ingin memesan lagi
                        ...
                        if user["username"] == username:
                            ...
                            if dana.isdigit():
                                ...
                                if dana > 2000000:
                                    ...
                                    user["saldo"] = str(int(user["saldo"]) + int(dana))
